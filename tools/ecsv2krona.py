...
def _set_options():
	...
	parser.add_argument('-i','--input', help='Id followed by TAB delimited file with results of blast from blast2ecsv. \
		Example -i s10 s10/s10.csv -i s9 s9/s9.csv', action='append', required=True, dest='input', nargs='+')
